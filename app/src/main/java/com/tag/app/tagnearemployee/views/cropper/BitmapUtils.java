...
final class BitmapUtils {
  ...
  static Uri writeTempStateStoreBitmap(Context context, Bitmap bitmap, Uri uri) {
    try {
      ...
      Log.d("AIC", "Failed to write bitmap to temp file for image-cropper save instance state", e);
      return null;
    }
  }
  ...
  static Bitmap resizeBitmap(
    ...
    try {
      ...
      Log.d("AIC", "Failed to resize cropped image, return bitmap before resize", e);
    }
    return bitmap;
  }
