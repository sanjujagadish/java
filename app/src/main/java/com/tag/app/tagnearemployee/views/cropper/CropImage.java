...
package com.tag.app.tagnearemployee.views.cropper;
...
public final class CropImage {
    ...
    public static boolean isImageIntentRequired = false;

    public static boolean shouldFrontCameraOpen = false;
    ...
    public static void startPickImageActivity(@NonNull Activity activity) {
        activity.getIntent().setFlags( Intent.FLAG_GRANT_READ_URI_PERMISSION);
     ...
     * Result will be received in {@link Activity#(int, int, Intent )} and can be
     ...
     * #activity(Uri)}.
     *
     * @param data result data intent as received in {@link Activity#(int, int,
     *             Intent )}.
