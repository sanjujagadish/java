package com.tag.app.tagnearemployee.qrcode.QrCode;
...
public class CameraSource {
     ...
     *
     * @throws runtime exception if the method fails
     */
    @SuppressLint("InlinedApi")
    private Camera createCamera() {
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes() != null && parameters.getSupportedFlashModes().contains(
                    mFlashMode)) {
    ...
    public static class Builder {
        private final com.google.android.gms.vision.Detector<?> mDetector;
         ...
         */
        public Builder(Context context, com.google.android.gms.vision.Detector<?> detector) {
            if (context == null) {
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        private com.google.android.gms.vision.Detector<?> mDetector;
        ...
        FrameProcessingRunnable(com.google.android.gms.vision.Detector<?> detector) {
            mDetector = detector;
        }
